                ...
                <div class="col-lg-8 col-md-8 col-10 offset-lg-2 offet-md-2-col col-1">
                    <form action="/action_page.php">
                        <div class="form-group">
                          ...
                          if(isset($_GET['error']))
                          {
                            $comment="Please provide the comments ";
                          ...
                          ?>
                          <input type="text" class="form-control" placeholder="Enter name" id="username" required autocomplete="off",name="Uname">
                        </div>
                        <form action="/action_page.php">
                            <div class="form-group">
                            ...
                            <form action="/action_page.php">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Enter mobile number" id="mobile" required autocomplete="off", name="number">
                                </div>
                                <div class="form-group">
